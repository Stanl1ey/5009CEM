...
<style>
  ...
  /* 3) Force all rows to plain white (remove any shading classes) */
  #example1 tbody tr,
  .bg-g, .bg-r {
...
<section class="content-header">
  ...
  <div class="content-header-right">
    <a href="size-add.php" class="btn btn-success btn-md">
      ...
      <table id="example1" class="table table-bordered table-hover table-striped">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="size-edit.php?id=<?= $row['size_id']; ?>" class="btn btn-primary btn-xs">
                <i class="fa fa-pencil"></i> Edit
              </a>
              <button class="btn btn-danger btn-xs"
                      data-toggle="modal"
                      data-target="#confirm-delete"
                      data-href="size-delete.php?id=<?= $row['size_id']; ?>">
